...
// Você pode querer importar tipos como Criterion aqui se necessário para getBestValue
// import { Criterion } from '@/hooks/useParametersData'; // Ou do seu shared-types
