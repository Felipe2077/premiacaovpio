...
//   // Preparar dados do ranking para compartilhamento
//   const rankingForShare = React.useMemo(() => {
//     if (!resultsBySector || Object.keys(resultsBySector).length === 0)
//       return [];

//     // Converter dados para formato de ranking
//     const rankingData = Object.entries(resultsBySector)
//       .map(([sectorId, data]: [string, any]) => {
//         const totalPoints = Object.values(data.criterios || {}).reduce(
...
//         };
//       })
//       .sort((a, b) => a.pontos - b.pontos); // Menor pontuação = melhor

//     // Adicionar posição e marcar vencedor
//     return rankingData.map((item, index) => ({
//       position: index + 1,
//       setor: item.setor,
//       pontos: item.pontos,
//       isWinner: index === 0, // Primeiro colocado é o vencedor
//     }));
//   }, [resultsBySector]);
