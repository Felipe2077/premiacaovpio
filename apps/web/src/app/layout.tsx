      ...
      <body className={`${inter.className} min-h-screen flex flex-col`}>
        ...
        <header className='bg-gray-800 text-white p-4 shadow-md sticky top-0 z-50'>
          ...
          <nav className='container mx-auto flex flex-wrap gap-x-6 gap-y-2 items-center'>
            ...
            {/* Título/Home */}
            {/* Link para a Visão B (se ela for a home '/', este é redundante mas pode ficar) */}
            <Link
              href='/'
            ...
            {/* Links Placeholders para futuras views (descomentar quando criar as rotas) */}
            {/* <Link href="/visao-a" className="text-sm sm:text-base text-gray-500 cursor-not-allowed" aria-disabled="true" onClick={(e)=>e.preventDefault()}>Visão Detalhada (A)</Link> */}
